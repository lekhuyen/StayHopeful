                        ...
                        <div class="nav-btn">
                            <div class="nav-links">
                                ...
                                <div class="log-sign-dropdown" style="--i: 1.8s">
                                    @if (session('userInfo'))
                                        <a href="{{ route('auth.profile') }}" class="btn-mobile solid" style="text-decoration: none">PROFILE</a> 
                                        @if (session('userInfo')['avatar'])
                                        ...
                                        @endif
                                @else
                                <a href="#" class="btn-mobile solid popup-login-responsive-mobile" style="text-decoration: none;">LOGIN</a>
                                @endif
                                    {{-- <a href="#" class="btn solid">LOGIN</a> --}}
                                </div>
                                {{-- <div class="log-sign-dropdown" style="--i: 1.8s">
