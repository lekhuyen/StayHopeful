...
@section('main')
    ...
    <div class="container about-story1" data-aos="zoom-in-left">
        <div class="row row-cols-1 row-cols-md-2 g-10">
            <div class="col story1">
                ...
                <div>
                    <span> As a small group of passionate individuals, we founded <strong>StayHopeful</strong> with a
                        shared commitment to making a difference. Inspired by the stories of resilience in the face of
                        adversity, we set out on a mission to combat diseases, end animal cruelty, and respond to natural
                        disasters. Over the years, we've faced challenges head-on, but the stories of transformation keep us
                        driven.</span>
                </div>
            ...
            <div class="col" data-aos="fade-left" data-aos-duration="1000">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Your contribution can make a life-saving impact. By donating now, you help us
                            provide crucial support and resources to those in need. Join us in the fight against diseases,
            ...
            <div class="col" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                ...
                <div class="card" ata-aos="fade-up" data-aos-duration="3000">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Become a part of our community to receive exclusive updates and be the first to
                            know about our impactful initiatives.</p>
                        <br>
                        <a href="#">Sign In</a></p>
                    </div>
                </div>
            ...
            <div class="col" class="col" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Join us in supporting our cause and contribute to positive change. Your
                            dedication can help us bring hope, healing, and resilience to those who need it most.</p>
                        <a href="#">Sign In</a></p>
                    </div>
                </div>
            </div>
    ...
    <div class="container mt-3 our_founder">
        ...
        <div class="team-description">
            ...
            project, there's a team of dedicated individuals committed to making a positive difference. Together, we share a
            common vision, diverse skills, and an unwavering commitment to creating a world where hope, compassion, and
            resilience thrive.
        </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-8">
                    <p class="text-justify">
                        Meet John Doe, the visionary behind <strong>Stay hope full</strong>. As the driving force behind the
                        organization's mission, John's passion for making a positive impact has been evident since its
