...
<div class="main-container d-flex">
    <div class="sidebar" id="side_nav">
        ...
        <ul class="ul__sidebar list-unstyled px-2">
            ...
            <li><a href="{{ route('aboutuspage.index') }}" class="text-decoration-none px-3 py-2 d-block"><i
            ...
            @can('comment_list')
                <li><a href="{{ route('comment.index') }}" class="text-decoration-none px-3 py-2 d-block"><i
                        class="fa-solid fa-comment" style="padding-right: 10px"></i>Comment</a></li>
            @endcan
        </ul>
