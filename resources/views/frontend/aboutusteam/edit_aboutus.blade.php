    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('aboutusteam.update', $aboutusteam) }}">
      ...
      @method("PUT")
        <div class="form-group mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" value="{{ $aboutusteam->name }}">
        </div>
        
        <div class="form-group mb-3">
            <label for="age">Age:</label>
            <input type="number" class="form-control" id="age" placeholder="Enter age" name="age" value="{{ $aboutusteam->age }}">
        </div>

        <div class="form-group mb-3 mt-3">
          <label for="email">Email:</label>
          <input type="text" class="form-control" id="email" placeholder="Enter email" name="email" value="{{ $aboutusteam->email }}">
        </div>
        ...
        <div class="form-group mb-3">
          ...
          <select class="form-control" id="skill" name="skill">
              ...
              <option value="Lead Developer Team" @if($aboutusteam->skill == 'Lead Developer Team') selected @endif>Lead Developer Team</option>
        ...
        <div class="form-group mb-3">
          <div class="form-check">
              <input type="radio" class="form-check-input" id="radio1" name="status" value="1" @if($aboutusteam->status == "1") checked @endif>
              <label class="form-check-label" for="radio1">Active</label>
          </div>
      
          <div class="form-check">
              <input type="radio" class="form-check-input" id="radio2" name="status" value="0" @if($aboutusteam->status == "0") checked @endif>
